...
export default function ClippedDrawer() {
  ...
  return (
    <div className={classes.root}>
      ...
      >
        {/*  This adds  space in left side                            <Toolbar /> */}
        <div className={classes.drawerContainer}>
          {/* Main Writting area inside left side bar */}
            <h3>Patients</h3>
            <SearchBar className= {classes.search} placeholder="Search Patient" variant="outlined" style={{borderRadius:0}}/>



                                        <Card className={classes.card1} variant="outlined">
                                            <CardHeader style={{fontSize:"2px",color:"white"}}
                                                  avatar={
                                                ...
                                                title="Sara Smith"
                                                subheader={<Typography className={classes.subColor}>15 Aug 2020</Typography>}
                                      ...
                                      <Card className={classes.card2} variant="outlined">
                                            <CardHeader
                                                ...
                                                title="James Jhon"
                                                subheader= {<Typography style={{color:"grey",fontSize:"10px"}}>No Clearence</Typography>}
                                      ...
                                      <Card className={classes.card2} variant="outlined">
                                            <CardHeader
                                                ...
                                                title="Patrice Page"
                                                subheader={<Typography style={{color:"grey",fontSize:"10px"}}>19 Aug 2020</Typography>}
                                          />
                                      ...
                                      <Card className={classes.card2} variant="outlined">
                                            <CardHeader
                                                ...
                                                title="Derek Dia"
                                                subheader={<Typography style={{color:"grey",fontSize:"10px"}}>21 Aug 2020</Typography>}
                                          />
